...
- [X] Study the code base and identify both responsive units and where media queries were used.  Take notes on anything that confuses you or interesting things you find.  Share this information in your standup meeting with your group
	- I like how they used comments to define which section was which 
	- Use of span more than we have thus far
	- HTML index file did not confuse me
	- What is "-webkit" and "-ms" in CSS?
	- Noticed media queries like we have practiced, based on screen size --> enables responsive pages 
	- Mostly em's were used for font sizes 
